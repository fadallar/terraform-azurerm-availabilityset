...
variable "platform_update_domain_count" {
  description = <<DESC
  Specifies the number of update domains that are used. Changing this forces a new resource to be created. 
  If the fault domain is set to 1 the update domain must be set to 1
  DESC
  type        = number
  default     = 5
  validation {
